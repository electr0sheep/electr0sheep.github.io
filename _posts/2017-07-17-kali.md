...
and a full Linux install <a href="https://www.maketecheasier.com/persistent-live-usb-vs-full-install-usb/">here</a>.
...
<div class="alert alert-info" role="alert">
You set the password to unlock the partition, so it's not going to be <strong>toor</strong>
...
`sudo apt-get upgrade` will take a LONG time!!
</div>
