...
4. Fixing the tilde key on MacBooks
5. Setting up an actual user account and disabling the root user
...
MacBook's wifi adapter, and you'll have access to monitor mode.
